...
var addedToCart = /*#__PURE__*/function () {
    ...
    return _regenerator["default"].wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return cartService.addedToCart(req.body.EmailId, req.params._id);
        case 3:
          data = _context.sent;
  ...
  return function addedToCart(_x, _x2, _x3) {
...
var removeBookFromCart = /*#__PURE__*/function () {
    ...
    return _regenerator["default"].wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _context2.prev = 0;
          _context2.next = 3;
          return cartService.removeBookFromCart(req.body.EmailId, req.params._id);
        case 3:
          data = _context2.sent;
          res.status(_httpStatusCodes["default"].CREATED).json({
            code: _httpStatusCodes["default"].CREATED,
  ...
  return function removeBookFromCart(_x4, _x5) {
...
var purchaseById = /*#__PURE__*/function () {
    ...
    return _regenerator["default"].wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          _context3.prev = 0;
          _context3.next = 3;
          return cartService.isPurchased(req.params._id);
        case 3:
          data = _context3.sent;
          res.status(_httpStatusCodes["default"].CREATED).json({
            code: _httpStatusCodes["default"].CREATED,
  ...
  return function purchaseById(_x6, _x7) {
